...
LOCK
TABLES `accounts_user` WRITE;
/*!40000 ALTER TABLE `accounts_user` DISABLE KEYS */;
INSERT INTO `accounts_user`
VALUES (1, 'pbkdf2_sha256$216000$Wcvym26tIt1G$L5v8pRRnU3v2JnDJnEr3HwFYRpfMQ8s62jP+f8VtbbQ=', NULL, 1, 'admin', 'irene.chae@uhn.ca', 1, 1, 1, 1, 1, 1, 1);
...
LOCK
TABLES `accounts_user_groups` WRITE;
...
LOCK
TABLES `accounts_user_user_permissions` WRITE;
...
LOCK
TABLES `api_cancerhotspot` WRITE;
...
(
    ...
    `statement`     longtext,
    `evid_sig`    varchar(4)  null,
    `level`       varchar(1)  null,
    `evid_dir`    tinyint(1)  null,
    `clin_sig`    varchar(25) null,
    `drug_class`  longtext    null,
    `evid_rating` int         null,
...
(
    ...
    `variant_id` int DEFAULT NULL,
    PRIMARY KEY (`id`),
    KEY          `api_predpmid_variant_id_9b04b65b_fk_api_variant_id` (`variant_id`),
    CONSTRAINT `api_predpmid_variant_id_9b04b65b_fk_api_variant_id` FOREIGN KEY (`variant_id`) REFERENCES `api_variant` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `api_predpmid_genes`
--

DROP TABLE IF EXISTS `api_predpmid_genes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `api_predpmid_genes`
(
    `id`                int NOT NULL AUTO_INCREMENT,
    `predpmid_id` int NOT NULL,
    `gene_id`           int NOT NULL,
    PRIMARY KEY (`id`),
    UNIQUE KEY `api_predpmid_genes_predpmid_id_gene_id_7ce4483b_uniq` (`predpmid_id`,`gene_id`),
    KEY                 `api_predpmid_genes_gene_id_332b2314_fk_api_gene_id` (`gene_id`),
    CONSTRAINT `api_predpmid_g_predpmid_id_363ce684_fk_api_inter` FOREIGN KEY (`predpmid_id`) REFERENCES `api_predpmid` (`id`),
    CONSTRAINT `api_predpmid_genes_gene_id_332b2314_fk_api_gene_id` FOREIGN KEY (`gene_id`) REFERENCES `api_gene` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `api_predpmid_genes`
--

LOCK
TABLES `api_predpmid_genes` WRITE;
/*!40000 ALTER TABLE `api_predpmid_genes` DISABLE KEYS */;
/*!40000 ALTER TABLE `api_predpmid_genes` ENABLE KEYS */;
UNLOCK
TABLES;

--
-- Table structure for table `api_predpmid_variants`
--

DROP TABLE IF EXISTS `api_predpmid_variants`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `api_predpmid_variants`
(
    `id`                int NOT NULL AUTO_INCREMENT,
    `predpmid_id` int NOT NULL,
    `variant_id`        int NOT NULL,
    PRIMARY KEY (`id`),
    UNIQUE KEY `api_predpmid_varia_predpmid_id_varian_626d2605_uniq` (`predpmid_id`,`variant_id`),
    KEY                 `api_predpmid_v_variant_id_81cb755e_fk_api_varia` (`variant_id`),
    CONSTRAINT `api_predpmid_v_predpmid_id_7712e4a0_fk_api_inter` FOREIGN KEY (`predpmid_id`) REFERENCES `api_predpmid` (`id`),
    CONSTRAINT `api_predpmid_v_variant_id_81cb755e_fk_api_varia` FOREIGN KEY (`variant_id`) REFERENCES `api_variant` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `api_predpmid_variants`
--

LOCK
TABLES `api_predpmid_variants` WRITE;
/*!40000 ALTER TABLE `api_predpmid_variants` DISABLE KEYS */;
/*!40000 ALTER TABLE `api_predpmid_variants` ENABLE KEYS */;
UNLOCK
TABLES;
...
(
    ...
    `cosmic70`              varchar(500)  DEFAULT NULL,
    `clinvar`               varchar(20)  DEFAULT NULL,
    `insilicodamaging`      varchar(100)  DEFAULT NULL,
...
LOCK
TABLES `auth_group_permissions` WRITE;
...
LOCK
TABLES `auth_permission` WRITE;
/*!40000 ALTER TABLE `auth_permission` DISABLE KEYS */;
INSERT INTO `auth_permission`
VALUES (1, 'Can add disease', 1, 'add_disease'),
       (2, 'Can change disease', 1, 'change_disease'),
       (3, 'Can delete disease', 1, 'delete_disease'),
       (4, 'Can view disease', 1, 'view_disease'),
       (5, 'Can add evidence', 2, 'add_evidence'),
       (6, 'Can change evidence', 2, 'change_evidence'),
       (7, 'Can delete evidence', 2, 'delete_evidence'),
       (8, 'Can view evidence', 2, 'view_evidence'),
       (9, 'Can add gene', 3, 'add_gene'),
       (10, 'Can change gene', 3, 'change_gene'),
       (11, 'Can delete gene', 3, 'delete_gene'),
       (12, 'Can view gene', 3, 'view_gene'),
       (13, 'Can add path item', 4, 'add_pathitem'),
       (14, 'Can change path item', 4, 'change_pathitem'),
       (15, 'Can delete path item', 4, 'delete_pathitem'),
       (16, 'Can view path item', 4, 'view_pathitem'),
       (17, 'Can add variant', 5, 'add_variant'),
       (18, 'Can change variant', 5, 'change_variant'),
       (19, 'Can delete variant', 5, 'delete_variant'),
       (20, 'Can view variant', 5, 'view_variant'),
       (21, 'Can add sub evidence', 6, 'add_subevidence'),
       (22, 'Can change sub evidence', 6, 'change_subevidence'),
       (23, 'Can delete sub evidence', 6, 'delete_subevidence'),
       (24, 'Can view sub evidence', 6, 'view_subevidence'),
       ...
       (33, 'Can add predpmid', 9, 'add_predpmid'),
       (34, 'Can change predpmid', 9, 'change_predpmid'),
       (35, 'Can delete predpmid', 9, 'delete_predpmid'),
       (36, 'Can view predpmid', 9, 'view_predpmid'),
       ...
       (45, 'Can add cancer hotspot', 12, 'add_cancerhotspot'),
       (46, 'Can change cancer hotspot', 12, 'change_cancerhotspot'),
       (47, 'Can delete cancer hotspot', 12, 'delete_cancerhotspot'),
       (48, 'Can view cancer hotspot', 12, 'view_cancerhotspot'),
...
LOCK
TABLES `django_content_type` WRITE;
/*!40000 ALTER TABLE `django_content_type` DISABLE KEYS */;
INSERT INTO `django_content_type`
VALUES (13, 'accounts', 'user'),
       (14, 'admin', 'logentry'),
       (12, 'api', 'cancerhotspot'),
       (1, 'api', 'disease'),
       (2, 'api', 'evidence'),
       (3, 'api', 'gene'),
       (10, 'api', 'history'),
...
LOCK
TABLES `django_migrations` WRITE;
/*!40000 ALTER TABLE `django_migrations` DISABLE KEYS */;
INSERT INTO `django_migrations`
VALUES (1, 'contenttypes', '0001_initial', '2020-12-16 10:29:51.961695'),
       (2, 'contenttypes', '0002_remove_content_type_name', '2020-12-16 10:29:52.008398'),
       (3, 'auth', '0001_initial', '2020-12-16 10:29:52.061544'),
       (4, 'auth', '0002_alter_permission_name_max_length', '2020-12-16 10:29:52.181906'),
       (5, 'auth', '0003_alter_user_email_max_length', '2020-12-16 10:29:52.191009'),
       (6, 'auth', '0004_alter_user_username_opts', '2020-12-16 10:29:52.204328'),
       (7, 'auth', '0005_alter_user_last_login_null', '2020-12-16 10:29:52.225704'),
       (8, 'auth', '0006_require_contenttypes_0002', '2020-12-16 10:29:52.229684'),
       (9, 'auth', '0007_alter_validators_add_error_messages', '2020-12-16 10:29:52.255795'),
       (10, 'auth', '0008_alter_user_username_max_length', '2020-12-16 10:29:52.272458'),
       (11, 'auth', '0009_alter_user_last_name_max_length', '2020-12-16 10:29:52.289596'),
       (12, 'auth', '0010_alter_group_name_max_length', '2020-12-16 10:29:52.314108'),
       (13, 'auth', '0011_update_proxy_permissions', '2020-12-16 10:29:52.322852'),
       (14, 'auth', '0012_alter_user_first_name_max_length', '2020-12-16 10:29:52.329718'),
       (15, 'accounts', '0001_initial', '2020-12-16 10:29:52.392344'),
       (16, 'admin', '0001_initial', '2020-12-16 10:29:52.524524'),
       (17, 'admin', '0002_logentry_remove_auto_add', '2020-12-16 10:29:52.584765'),
       (18, 'admin', '0003_logentry_add_action_flag_choices', '2020-12-16 10:29:52.603441'),
       (19, 'api', '0001_initial', '2020-12-16 10:29:53.164962'),
       (20, 'sessions', '0001_initial', '2020-12-16 10:29:53.690321');
